# Given hexadecimal values for keys and encrypted flag parts
...
# Convert hexadecimal strings to lists of integers (byte values)
...
# XOR the encrypted flag parts (flag_k1_k3_k2_ord) with k2_k3_ord
flag_k1_ord = [
    o_f132 ^ o23 for (o_f132, o23) in zip(flag_k1_k3_k2_ord, k2_k3_ord)
]

# XOR the result (flag_k1_ord) with k1_ord
